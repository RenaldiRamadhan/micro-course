...
class MyCourseController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        // cek tipe course nya premium atau ga, kalo ga langsung kasi akses ke baris (96)
        if ($course->type === 'premium') {
            ...
            // buat helper dulu buat manggil service order payment
            $order = postOrder([
                'user' => $user['data'],
    ...
    // user milih kelas yang mau dibeli
